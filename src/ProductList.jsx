...
function ProductList() {
    ...
    const totalItemsInCart = useSelector(selectTotalQuantity);
    ...
    const handleAddToCart = (product) => {
        ...
        setAddedToCart((prevState) => ({
            ...prevState,
            [product.name]: true, // Mark this plant as added to cart
        }));
    };
    
    const handleRemoveFromCart = (product) => {
        dispatch(removeItem(product)); // Dispatch remove action to Redux store
        setAddedToCart((prevState) => {
            const updatedState = { ...prevState };
            delete updatedState[product.name]; // Remove the product from addedToCart
            return updatedState;
        });
    };
                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a href="#" onClick={handleCartClick} style={{ color: 'white', fontSize: '30px', textDecoration: 'none' }}>
                            <h1 className="cart-icon">🛒 {totalItemsInCart}</h1>
                        </a>
                    </div>
                </div>
            </div>
